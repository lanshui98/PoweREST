...
#' nCol=50,...)
#' @param x A \href{https://cran.r-project.org/web/packages/scam/index.html}{scam} object.
...
#' @return A 2d plot of the power surface. More details can be seen at \href{https://cran.r-project.org/web/packages/scam/index.html}{scam}.
#' @export
#'
#' @examples
#' data(result_example)
