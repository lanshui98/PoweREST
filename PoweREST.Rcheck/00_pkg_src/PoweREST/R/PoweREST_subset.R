...
#' in '...' (more test options can be refered to \href{https://cran.r-project.org/web/packages/Seurat/index.html}{Seurat}.
...
#' min.pct = 0.01,...)
#' @param Seurat_obj A \href{https://cran.r-project.org/web/packages/Seurat/index.html}{Seurat} object.
