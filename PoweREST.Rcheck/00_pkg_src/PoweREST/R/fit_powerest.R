...
#' and utilizes the \href{https://cran.r-project.org/web/packages/scam/index.html}{scam} package to fit two dimensional
...
#' at the document of R package \href{https://cran.r-project.org/web/packages/scam/index.html}{scam}.
#' @export
#'
#' @examples
#' data(result_example)
